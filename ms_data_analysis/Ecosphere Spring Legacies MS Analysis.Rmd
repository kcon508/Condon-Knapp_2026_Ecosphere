...
# Read in data
vwc.dat<-read.csv("ms_data_analysis/SGS_SLs_20cmVWC_all.csv")
...
# ggsave(vwc.plot,filename="ms_fig_panels/MS_SGS_2021_VWC_lines.pdf",bg="transparent",width=11.5,height=5)
...
## Export plot
# ggsave(vwc.avs.del.periods,filename="ms_fig_panels/MS_SGS_2021_VWC_periodbars.pdf",bg="transparent",height=5,width=5)
...
# Read in data
gcc.dat<-read.csv("ms_data_analysis/SGS_SLs_GCC_all.csv")
...
## Export plot
# ggsave(gcc.avs.del.periods,filename="ms_fig_panels/MS_SGS_2021_GCC_periodbars.pdf",bg="transparent",width=5,height=5)
```

### 3. Efflux
```{r Respiration data setup, include=FALSE}
# Read in data 
resp.dat<-read.csv("ms_data_analysis/SGS_SLs_Respiration_all.csv")
...
# ggsave(efflux.plot,filename="ms_fig_panels/MS_SGS_2021_Efflux_lines.pdf",bg="transparent",width=11.5,height=5)
...
## Export plot
# ggsave(efflux.avs.del.periods,filename="ms_fig_panels/MS_SGS_2021_Efflux_periodbars.pdf",bg="transparent",width=4,height=5)
```
...
anpp<-read.csv("ms_data_analysis/SGS_SLs_ANPP_all.csv")
...
name="ms_fig_panels/MS_SGS_2021_Regrowth_ANPP_3trts.pdf"
letters<-c("a","b","a")

## Turn on for Sept Plot
# gr_dat<-subset(anpp.avs,anpp.avs$Clip_Type=="September")
# name="ms_fig_panels/MS_SGS_2021_September_ANPP.pdf"
# letters<-c("ab","a","b")
...
```{r ANPP all functional groups - analyses only}
funct.groups<-read.csv("ms_data_analysis/SGS_SLs_ANPP_functgroups.csv")
str(funct.groups)
...
funct.re$group<-funct.re$ANNUALS
...
# Read in data
prs.dat<-read.csv('ms_data_analysis/SGS_SLs_PRS_NO3droppedlow.csv')
str(prs.dat)
...
# ggsave(NO3.plot,filename="ms_fig_panels/SGS_2021_MS_NO3.pdf",bg="transparent",width=5,height=5)
...
#### Sentek data ####
sentek.dat<-read.csv("ms_data_analysis/SGS_SLs_2021_Interpolated_Sentek_VWC.csv")
...
## Export plot
# ggsave(sentek.avs.del.periods,filename="ms_fig_panels/MS_SGS_2021_Sentek_periodbars.pdf",bg="transparent",width=5,height=5)
...
sentek_avs<-ggplot(allsm.trts.1, aes(Date, depth)) +
  ...
  # scale_fill_gradientn(limits=c(0,50),colours = rainbow(9))+ # scale to match Hoover paper (but loses some data b/c > 50)
  theme_classic()+
  ylab("Depth (cm)") +
  xlab("") +
  theme_classic()+
...
# ggsave(sentek_avs,filename="ms_fig_panels/MS_SGS_2021_sentek_heatmap.pdf",width=10,height=3.5)
...
#### Daily precip data ####
daily.precip<-read.csv("ms_data_analysis/SGS_Precip_Combined.csv")
