# Condon-Knapp_2026_Ecosphere
Data and code associated with Ecosphere manuscript "Subtle differences in spring soil moisture can substantially influence annual productivity in a semiarid grassland"  
...
### SGS_SLs_ANPP_functgroup.csv
Analysis only to check for functional group shifts in ANPP, associated with (4) ANPP
- same descriptions as above for shared columns
- C3: C3 perennial grasses biomass (g/m2)
- C4: C4 perennial grasses biomass (g/m2)
- FORB: Forb biomass (g/m2)
- ANNUALS: C3 annual grasses biomass (g/m2)
- WOODY: Woody plant biomass - typically not present (g/m2)
- C3.grasses: Total of C3 + ANNUALS
- C3.total: Total of C3 + ANNUALS + FORB
- ANPP: Total of C3 + C4 + FORB + ANNUALS + WOODY (if present)
- Total.Grasses: Total of C3 + C4 + ANNUALS
